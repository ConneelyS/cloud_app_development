...
class MicropostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create micropost" do
    assert_difference('Micropost.count') do
      post microposts_url, params: { micropost: { doctor_notes: @micropost.doctor_notes, patient_id: @micropost.patient_id } }
    end
  ...
  test "should update micropost" do
    patch micropost_url(@micropost), params: { micropost: { doctor_notes: @micropost.doctor_notes, patient_id: @micropost.patient_id } }
